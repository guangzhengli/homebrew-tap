cask "kapinote" do
  version "0.9.5"
  sha256 "490316dc2d4ae7f3c8836d0087a0876105e9d45aacd53f6968792db09a8890f9"

  url "https://github.com/guangzhengli/kapinote-releases/releases/download/v#{version}/Kapinote_0.9.5_aarch64.dmg"
  name "Kapinote"
